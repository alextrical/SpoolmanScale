...
void buildMoreInfoScreen() {
  ...
  lv_obj_set_style_text_font(c_uid, &lv_font_montserrat_ext_14, 0);
  ...
  lv_obj_set_style_text_font(v_uid, &lv_font_montserrat_ext_18, 0);
  ...
  lv_obj_set_style_text_font(c_smid2, &lv_font_montserrat_ext_14, 0);
  ...
  lv_obj_set_style_text_color(v_smid2,
    (sm_found && sm_id > 0) ? lv_color_hex(0x28d49a) : lv_color_hex(0xf0b838), 0);
  lv_obj_set_style_text_font(v_smid2, &lv_font_montserrat_ext_18, 0);
